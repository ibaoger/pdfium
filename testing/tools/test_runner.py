...
class TestRunner:
  ...
  def Run(self):
    ...
    parser.add_option('--regenerate_expected', default='', dest="regenerate_expected",
                      help='Regenerates expected images. Valid values are "all" to regenerate all expected pngs, and "platform" to regenerate only platform-specific expected pngs.')
    ...
    if (self.options.regenerate_expected is not None
