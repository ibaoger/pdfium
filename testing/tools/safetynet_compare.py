...
# A value for --png-dir that means "generate pngs on the same dir as each test
# file"
SAME_DIR = 'SAME_DIR'
...
def main():
  ...
  parser.add_argument('--pages',
                      help='selects some pages to be rendered. First page is '
                           '0. "--pages A" will render only page A. '
                           '--pages A-B will render pages A to B (inclusive).')
  ...
  if args.png_dir and args.png_dir != SAME_DIR:
