...
class ImageComparison(object):
  ...
  def _WriteImageRows(self, f, image):
  ...
  def _GenerateDiffs(self):
    ...
    # different = {}
    # for image in self.image_locations.Images():
    #   _, different[image] = self.GenerateOneDiff(image)
