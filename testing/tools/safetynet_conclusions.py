...
class CaseResult(object):
  """The concluson for the comparison of a single test case."""
...
def PrintConclusionsDictHumanReadable(conclusions_dict, colored):
  ...
  for case_name, case_dict in sorted(conclusions_dict['comparison_by_case']
    ...
    if case_dict['rating'] == RATING_FAILURE:
      print 'Failed to measure time for %s' % case_name
      continue
