  ...
  while (!is_stop(cmd)) {
    switch (m_status) {
      ...
      case ready:
        ...
        break;
      case cap1:
        stroke_calc_cap(m_out_vertices, m_src_vertices[0], m_src_vertices[1],
                        m_src_vertices[0].dist, m_line_cap, m_width,
                        m_approx_scale);
        m_src_vertex = 1;
      ...
      case cap2:
        stroke_calc_cap(m_out_vertices,
                        ...
                        m_line_cap, m_width, m_approx_scale);
      ...
      case outline1:
        ...
        curj = m_src_vertices[m_src_vertex].cmd & path_flags_jr
                   ? miter_join_round
                   : m_line_join;
        stroke_calc_join(m_out_vertices, m_src_vertices.prev(m_src_vertex),
                         m_src_vertices.curr(m_src_vertex),
                         m_src_vertices.next(m_src_vertex),
                         m_src_vertices.prev(m_src_vertex).dist,
                         m_src_vertices.curr(m_src_vertex).dist, m_width, curj,
                         m_inner_join, m_miter_limit, m_inner_miter_limit,
                         m_approx_scale);
        ++m_src_vertex;
      ...
      case outline2:
        ...
        curj = m_src_vertices[m_src_vertex].cmd & path_flags_jr
                   ? miter_join_round
                   : m_line_join;
        stroke_calc_join(m_out_vertices, m_src_vertices.next(m_src_vertex),
                         m_src_vertices.curr(m_src_vertex),
                         m_src_vertices.prev(m_src_vertex),
                         m_src_vertices.curr(m_src_vertex).dist,
                         m_src_vertices.prev(m_src_vertex).dist, m_width, curj,
                         m_inner_join, m_miter_limit, m_inner_miter_limit,
                         m_approx_scale);
        m_prev_status = m_status;
        m_status = out_vertices;
