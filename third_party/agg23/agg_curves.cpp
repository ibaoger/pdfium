...
void curve4_div::recursive_bezier(float x1,
                                  float y1,
                                  float x2,
                                  float y2,
                                  float x3,
  ...
  switch ((int(d2 > curve_collinearity_epsilon) << 1) +
    ...
    case 0:
      if (FXSYS_fabs(x1 + x3 - x2 - x2) + FXSYS_fabs(y1 + y3 - y2 - y2) +
              FXSYS_fabs(x2 + x4 - x3 - x3) + FXSYS_fabs(y2 + y4 - y3 - y3) <=
...
void curve4_div::bezier(float x1,
                        float y1,
                        float x2,
                        float y2,
                        float x3,
