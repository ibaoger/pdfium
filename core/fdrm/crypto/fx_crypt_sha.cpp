...
void CRYPT_SHA512Start(void* context) {
  ...
  memset(ctx, 0, sizeof(CRYPT_sha384_context));
  ctx->state[0] = 0xa09e667f3bcc908;
  ctx->state[1] = 0xb67ae8584caa73b;
  ctx->state[2] = 0xc6ef372fe94f82b;
  ctx->state[3] = 0x54ff53a5f1d36f1;
  ctx->state[4] = 0x10e527fade682d1;
  ctx->state[5] = 0xb05688c2b3e6c1f;
  ctx->state[6] = 0xf83d9abfb41bd6b;
  ctx->state[7] = 0xbe0cd19137e2179;
}
