...
class CFX_Renderer {
 ...
 private:
  ...
  inline int GetSrcAlpha(const uint8_t* clip_scan, int col) {
  ...
  inline int GetColStart(int span_left, int clip_left) {
    return span_left < clip_left ? clip_left - span_left : 0;
  }

  inline int GetColEnd(int span_left, int span_len, int clip_right) {
