...
void Outline_CheckEmptyContour(OUTLINE_PARAMS* param) {
  if (param->m_PointCount >= 2 &&
      param->m_pPoints[param->m_PointCount - 2].m_Type == FXPT_TYPE::MoveTo &&
      !param->m_pPoints[param->m_PointCount - 2].m_CloseFigure &&
  ...
  if (param->m_PointCount >= 4 &&
      param->m_pPoints[param->m_PointCount - 4].m_Type == FXPT_TYPE::MoveTo &&
      !param->m_pPoints[param->m_PointCount - 4].m_CloseFigure &&
      param->m_pPoints[param->m_PointCount - 3].m_Type == FXPT_TYPE::BezierTo &&
      !param->m_pPoints[param->m_PointCount - 3].m_CloseFigure &&
