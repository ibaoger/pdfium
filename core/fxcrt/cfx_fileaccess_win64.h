...
#ifndef CORE_FXCRT_CFX_FILEACCESS_WIN64_H_
#define CORE_FXCRT_CFX_FILEACCESS_WIN64_H_

#include "core/fxcrt/ifx_fileaccess.h"

#if _FXM_PLATFORM_ == _FXM_PLATFORM_WINDOWS_
class CFX_FileAccess_Win64 : public IFX_FileAccess {
 public:
  CFX_FileAccess_Win64();
  ~CFX_FileAccess_Win64() override;
...
#endif  // CORE_FXCRT_CFX_FILEACCESS_WIN64_H_
