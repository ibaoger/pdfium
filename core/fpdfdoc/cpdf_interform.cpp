 ...
 public:
  class Node {
   public:
    ...
    explicit Node(const CFX_WideString& short_name)
        : m_ShortName(short_name), m_pField(nullptr) {}
    ~Node() {}
    ...
    CPDF_FormField* GetField() { return m_pField.get(); }
    const CPDF_FormField* GetField() const { return m_pField.get(); }
