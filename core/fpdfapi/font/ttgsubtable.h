...
class CFX_CTTGSUBTable {
 ...
 private:
  ...
  struct TFeatureList {
    ...
    std::vector<TFeatureRecord> FeatureRecord;
  ...
  struct TCoverageFormat2 : public TCoverageFormatBase {
    ...
    std::vector<TRangeRecord> RangeRecord;
  ...
  struct TSingleSubstFormat2 : public TSubTableBase {
    ...
    std::unique_ptr<TCoverageFormatBase> Coverage;
    std::vector<uint16_t> Substitute;
  ...
  struct TLookup {
    ...
    uint16_t LookupType;
    uint16_t LookupFlag;
    std::vector<TSubTableBase*> SubTable;
