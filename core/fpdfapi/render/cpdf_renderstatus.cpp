...
bool CPDF_RenderStatus::ProcessForm(const CPDF_FormObject* pFormObj,
  ...
  CPDF_RenderStatus status;
  status.Initialize(m_pContext.Get(), m_pDevice, nullptr, m_pStopObj.Get(),
                    this, pFormObj, &m_Options, m_Transparency, m_bDropObjects,
                    pResources, false);
...
bool CPDF_RenderStatus::ProcessTransparency(CPDF_PageObject* pPageObj,
  ...
  bitmap_render.Initialize(m_pContext.Get(), &bitmap_device, nullptr,
                           m_pStopObj.Get(), nullptr, nullptr, &m_Options, 0,
...
void CPDF_RenderStatus::DrawShading(CPDF_ShadingPattern* pPattern,
  ...
  buffer.Initialize(m_pContext.Get(), m_pDevice, &clip_rect, m_pCurObj.Get(),
                    150);
...
void CPDF_RenderStatus::CompositeDIBitmap(
  ...
  CFX_RetainPtr<CFX_DIBitmap> pBackdrop =
      GetBackdrop(m_pCurObj.Get(), rect, back_left, back_top,
