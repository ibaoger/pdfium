...
void CPDF_StreamContentParser::Handle_BeginText() {
  ...
  m_pCurStates->m_LinePos = CFX_PointF();
}
...
void CPDF_StreamContentParser::Handle_MoveTextPoint() {
  m_pCurStates->m_LinePos += CFX_PointF(GetNumber(1), GetNumber(0));
  m_pCurStates->m_TextPos = m_pCurStates->m_LinePos;
}
...
void CPDF_StreamContentParser::Handle_MoveToNextLine() {
  m_pCurStates->m_LinePos.y -= m_pCurStates->m_TextLeading;
  m_pCurStates->m_TextPos = m_pCurStates->m_LinePos;
}
