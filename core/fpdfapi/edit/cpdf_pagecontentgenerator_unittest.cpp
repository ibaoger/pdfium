...
TEST(cpdf_pagecontentgenerator, ProcessRect) {
  ...
  const CFX_ByteString rectangle1 = "10 5 3 25 re\n";
...
TEST(cpdf_pagecontentgenerator, ProcessPath) {
  ...
  FX_PATHPOINT* pPoints = pPathObj->m_Path.GetMutablePoints();
  pPoints[0].m_PointX = 3.102;
  pPoints[0].m_PointY = 4.67;
  pPoints[0].m_Flag = FXPT_MOVETO;
  pPoints[1].m_PointX = 5.45;
  pPoints[1].m_PointY = 0.29;
  pPoints[1].m_Flag = FXPT_LINETO;
  pPoints[2].m_PointX = 4.24;
  pPoints[2].m_PointY = 3.15;
  pPoints[2].m_Flag = FXPT_BEZIERTO;
  pPoints[3].m_PointX = 4.65;
  pPoints[3].m_PointY = 2.98;
  pPoints[3].m_Flag = FXPT_BEZIERTO;
  pPoints[4].m_PointX = 3.456;
  pPoints[4].m_PointY = 0.24;
  pPoints[4].m_Flag = FXPT_BEZIERTO;
  pPoints[5].m_PointX = 10.6;
  pPoints[5].m_PointY = 11.15;
  pPoints[5].m_Flag = FXPT_LINETO;
  pPoints[6].m_PointX = 11;
  pPoints[6].m_PointY = 12.5;
  pPoints[6].m_Flag = FXPT_LINETO;
  pPoints[7].m_PointX = 11.46;
  pPoints[7].m_PointY = 12.67;
  pPoints[7].m_Flag = FXPT_BEZIERTO;
  pPoints[8].m_PointX = 11.84;
  pPoints[8].m_PointY = 12.96;
  pPoints[8].m_Flag = FXPT_BEZIERTO;
  pPoints[9].m_PointX = 12;
  pPoints[9].m_PointY = 13.64;
  ...
  const CFX_ByteString rectangle =
      ...
      "11 12.5 l 11.46 12.67 11.84 12.96 12 13.64 c h\n";
