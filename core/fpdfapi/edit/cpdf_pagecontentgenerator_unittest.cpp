...
TEST_F(CPDF_PageContentGeneratorTest, ProcessText) {
  ...
  EXPECT_LT(83, textString.GetLength());
  EXPECT_EQ("BT 1 0 0 1 100 100 Tm /", textString.Left(23));
  EXPECT_EQ(" 10 Tf <00480065006C006C006F00200057006F0072006C0064> Tj ET\n",
            textString.Right(60));
  CPDF_Dictionary* fontDict = TestGetResource(
      &generator, "Font", textString.Mid(23, textString.GetLength() - 83));
