...
TEST_F(CPDF_CreatorEmbeddertest, SavedDocsIsEqualAfterParse) {
  ...
  // Saved docs should be equal.
  // Use EXPECT_TRUE to prevent spam into console (saved_doc_x is raw pdf
  // content)
  EXPECT_TRUE(saved_doc_1 == saved_doc_2);
}
