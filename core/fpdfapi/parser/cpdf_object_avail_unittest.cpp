...
TEST(CPDF_ObjectAvailTest, OneObject) {
  ...
  EXPECT_EQ(CPDF_ObjectAvail::AvailStatus::DataNotAvailable,
            avail.CheckAvail());
  holder.SetObjectState(1, TestHolder::ObjectState::Available);
  EXPECT_EQ(CPDF_ObjectAvail::AvailStatus::DataAvailable, avail.CheckAvail());
}
...
TEST(CPDF_ObjectAvailTest, SelfReferedInlinedObject) {
  ...
  EXPECT_EQ(CPDF_PageObjectAvail::AvailStatus::DataNotAvailable,
            avail.CheckAvail());

  holder.SetObjectState(2, TestHolder::ObjectState::Available);

  EXPECT_EQ(CPDF_PageObjectAvail::AvailStatus::DataAvailable,
            avail.CheckAvail());
}
