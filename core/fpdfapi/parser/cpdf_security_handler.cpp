...
CPDF_SecurityHandler::~CPDF_SecurityHandler() {
  std::cerr << "~CPDF_SecurityHandler m_pEncryptDict " << (void*)m_pEncryptDict.Get() << std::endl;
  std::cerr << "~CPDF_SecurityHandler m_FileId " << m_FileId << std::endl;
}

bool CPDF_SecurityHandler::OnInit(const CPDF_Dictionary* pEncryptDict,
                                  const CPDF_Array* pIdArray,
                                  const ByteString& password) {
  std::cerr << "CPDF_SecurityHandler::OnInit pIdArray " << (void*)pIdArray << std::endl;
