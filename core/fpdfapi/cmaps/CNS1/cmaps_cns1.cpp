...
void CPDF_ModuleMgr::LoadEmbeddedCNS1CMaps() {
  ...
  pFontGlobals->embedded_charsets_[CIDSET_CNS1].map_list_ = g_FXCMAP_CNS1_cmaps;
  pFontGlobals->embedded_charsets_[CIDSET_CNS1].count_ =
      FX_ArraySize(g_FXCMAP_CNS1_cmaps);
  pFontGlobals->embedded_to_unicodes_[CIDSET_CNS1].map_ =
      g_FXCMAP_CNS1CID2Unicode_5;
  pFontGlobals->embedded_to_unicodes_[CIDSET_CNS1].count_ = 19088;
}
