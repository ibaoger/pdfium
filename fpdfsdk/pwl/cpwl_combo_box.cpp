...
void CPWL_ComboBox::OnCreate(CREATEPARAM& cp) {
...
void CPWL_ComboBox::CreateChildWnd(const CREATEPARAM& cp) {
  CreateEdit(cp);
  CreateButton(cp);
  CreateListBox(cp);
}

void CPWL_ComboBox::CreateEdit(const CREATEPARAM& cp) {
  if (m_pEdit)
    return;
...
void CPWL_ComboBox::CreateButton(const CREATEPARAM& cp) {
  if (m_pButton)
    return;
...
void CPWL_ComboBox::CreateListBox(const CREATEPARAM& cp) {
  if (m_pList)
    return;
