...
TEST_F(FPDFTransformPageEmbeddertest, FPDF_TransFormPageNoClip) {
  ...
  FPDF_BITMAP bitmap = FPDFBitmap_Create(initial_width * scale_factor,
                                         initial_height * scale_factor, 0);
  FPDFBitmap_FillRect(bitmap, 0, 0, initial_width * scale_factor,
                      initial_height * scale_factor, 0xFFFFFFFF);
  FPDF_RenderPageBitmap(bitmap, page, 0, 0, initial_width * scale_factor,
                        initial_height * scale_factor, 0, 0);
  CompareBitmap(bitmap, initial_width * scale_factor,
                initial_height * scale_factor, kTransformedMD5);
