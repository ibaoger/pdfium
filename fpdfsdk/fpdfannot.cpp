...
FPDF_EXPORT FPDF_ANNOTATION CDECL
...
FPDF_EXPORT int CDECL FPDFPage_GetAnnotCount(FPDF_PAGE page) {
  CPDF_Page* pPage = CPDFPageFromFPDFPage(page);
...
FPDF_EXPORT FPDF_ANNOTATION CDECL FPDFPage_GetAnnot(FPDF_PAGE page, int index) {
  CPDF_Page* pPage = CPDFPageFromFPDFPage(page);
...
FPDF_EXPORT void CDECL FPDFPage_CloseAnnot(FPDF_ANNOTATION annot) {
  delete CPDFAnnotContextFromFPDFAnnotation(annot);
}

FPDF_EXPORT FPDF_BOOL CDECL FPDFPage_RemoveAnnot(FPDF_PAGE page, int index) {
  CPDF_Page* pPage = CPDFPageFromFPDFPage(page);
  if (!pPage || !pPage->m_pFormDict || index < 0)
    return false;
...
FPDF_EXPORT FPDF_ANNOTATION_SUBTYPE CDECL
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_UpdateObject(FPDF_ANNOTATION annot,
                                                   FPDF_PAGEOBJECT obj) {
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_AppendObject(FPDF_ANNOTATION annot,
                                                   FPDF_PAGEOBJECT obj) {
  CPDF_AnnotContext* pAnnot = CPDFAnnotContextFromFPDFAnnotation(annot);
  CPDF_PageObject* pObj = CPDFPageObjectFromFPDFPageObject(obj);
  if (!pAnnot || !pObj)
...
FPDF_EXPORT int CDECL FPDFAnnot_GetObjectCount(FPDF_ANNOTATION annot) {
  CPDF_AnnotContext* pAnnot = CPDFAnnotContextFromFPDFAnnotation(annot);
...
FPDF_EXPORT FPDF_PAGEOBJECT CDECL FPDFAnnot_GetObject(FPDF_ANNOTATION annot,
                                                      int index) {
  CPDF_AnnotContext* pAnnot = CPDFAnnotContextFromFPDFAnnotation(annot);
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_RemoveObject(FPDF_ANNOTATION annot,
                                                   int index) {
  CPDF_AnnotContext* pAnnot = CPDFAnnotContextFromFPDFAnnotation(annot);
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_SetColor(FPDF_ANNOTATION annot,
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_GetColor(FPDF_ANNOTATION annot,
                                               FPDFANNOT_COLORTYPE type,
                                               unsigned int* R,
                                               unsigned int* G,
                                               unsigned int* B,
...
FPDF_EXPORT FS_QUADPOINTSF CDECL
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_SetRect(FPDF_ANNOTATION annot,
                                              const FS_RECTF* rect) {
  if (!annot || !rect)
    return false;
...
FPDF_EXPORT FS_RECTF CDECL FPDFAnnot_GetRect(FPDF_ANNOTATION annot) {
  if (!annot)
    return FS_RECTF();
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_HasKey(FPDF_ANNOTATION annot,
                                             FPDF_WIDESTRING key) {
  if (!annot)
    return false;
...
FPDF_EXPORT FPDF_OBJECT_TYPE CDECL FPDFAnnot_GetValueType(FPDF_ANNOTATION annot,
                                                          FPDF_WIDESTRING key) {
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_SetStringValue(FPDF_ANNOTATION annot,
                                                     FPDF_WIDESTRING key,
...
FPDF_EXPORT unsigned long CDECL FPDFAnnot_GetStringValue(FPDF_ANNOTATION annot,
                                                         FPDF_WIDESTRING key,
                                                         void* buffer,
...
FPDF_EXPORT int CDECL FPDFAnnot_GetFlags(FPDF_ANNOTATION annot) {
  if (!annot)
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFAnnot_SetFlags(FPDF_ANNOTATION annot,
                                               int flags) {
  if (!annot)
    return false;
...
FPDF_EXPORT int CDECL FPDFAnnot_GetFormFieldFlags(FPDF_PAGE page,
