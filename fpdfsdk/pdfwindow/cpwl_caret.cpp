...
void CPWL_Caret::GetThisAppearanceStream(std::ostringstream* sAppStream) {
...
void CPWL_Caret::GetCaretApp(std::ostringstream* sAppStream,
  ...
  *sAppStream << "q\n";
  if (!rcClip.IsEmpty()) {
    *sAppStream << rcClip.left << " " << rcClip.bottom + 2.5f << " "
                << rcClip.right - rcClip.left << " "
                << rcClip.top - rcClip.bottom - 4.5f << " re W n\n";
  }
  *sAppStream << m_fWidth << " w\n0 G\n";
  *sAppStream << rcRect.left + m_fWidth / 2 << " " << rcRect.bottom << " m\n";
  *sAppStream << rcRect.left + m_fWidth / 2 << " " << rcRect.top << " l S\nQ\n";
}
