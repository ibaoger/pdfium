...
CPWL_Color CPWL_Utils::SubtractColor(const CPWL_Color& sColor,
                                     FX_FLOAT fColorSub) {
  CPWL_Color sRet;
...
CPWL_Color CPWL_Utils::DivideColor(const CPWL_Color& sColor,
                                   FX_FLOAT fColorDivide) {
  CPWL_Color sRet;
  sRet.nColorType = sColor.nColorType;
  ...
  switch (sColor.nColorType) {
    case COLORTYPE_TRANSPARENT:
      sRet.nColorType = COLORTYPE_RGB;
      sRet.fColor1 = 1 / fColorDivide;
      sRet.fColor2 = 1 / fColorDivide;
      sRet.fColor3 = 1 / fColorDivide;
      break;
    case COLORTYPE_RGB:
    case COLORTYPE_GRAY:
    case COLORTYPE_CMYK:
    ...
    switch (nStyle) {
      ...
      case BorderStyle::SOLID: {
        ...
        pDevice->DrawPath(&path, pUser2Device, nullptr,
                          color.ToFXColor(nTransparancy), 0, FXFILL_ALTERNATE);
        break;
      }
      case BorderStyle::DASH: {
        CFX_PathData path;
        ...
        pDevice->DrawPath(&path, pUser2Device, &gsd, 0,
                          color.ToFXColor(nTransparancy), FXFILL_WINDING);
        break;
      }
      case BorderStyle::BEVELED:
      case BorderStyle::INSET: {
        ...
        pDevice->DrawPath(&pathLT, pUser2Device, &gsd,
                          crLeftTop.ToFXColor(nTransparancy), 0,
                          FXFILL_ALTERNATE);
        ...
        pDevice->DrawPath(&pathRB, pUser2Device, &gsd,
                          crRightBottom.ToFXColor(nTransparancy), 0,
                          FXFILL_ALTERNATE);
      ...
      case BorderStyle::UNDERLINE: {
        ...
        pDevice->DrawPath(&path, pUser2Device, &gsd, 0,
                          color.ToFXColor(nTransparancy), FXFILL_ALTERNATE);
        break;
      }
    }
  }
