...
class CPWL_Wnd : public CPWL_TimerHandler {
 ...
 protected:
  ...
  virtual void GetThisAppearanceStream(std::ostringstream* sAppStream);
  ...
  void GetAppearanceStream(std::ostringstream* sAppStream);
 ...
 private:
  ...
  void GetChildAppearanceStream(std::ostringstream* sAppStream);
