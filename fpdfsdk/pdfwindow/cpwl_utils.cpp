...
CFX_ByteString CPWL_Utils::GetCheckBoxAppStream(const CFX_FloatRect& rcBBox,
  ...
  switch (nStyle) {
    ...
    case PCS_CIRCLE:
      return GetAppStream_Circle(rcCenter.Scale(2.0f / 3.0f), crText);
    case PCS_CROSS:
      return GetAppStream_Cross(rcCenter, crText);
    case PCS_DIAMOND:
      return GetAppStream_Diamond(rcCenter.Scale(2.0f / 3.0f), crText);
    case PCS_SQUARE:
      return GetAppStream_Square(rcCenter.Scale(2.0f / 3.0f), crText);
    case PCS_STAR:
      return GetAppStream_Star(rcCenter.Scale(2.0f / 3.0f), crText);
  }
}
...
CFX_ByteString CPWL_Utils::GetRadioButtonAppStream(const CFX_FloatRect& rcBBox,
  ...
  switch (nStyle) {
    ...
    case PCS_CHECK:
      return GetAppStream_Check(rcCenter, crText);
    case PCS_CIRCLE:
      return GetAppStream_Circle(rcCenter.Scale(1.0f / 2.0f), crText);
    case PCS_CROSS:
      return GetAppStream_Cross(rcCenter, crText);
    case PCS_DIAMOND:
      return GetAppStream_Diamond(rcCenter.Scale(2.0f / 3.0f), crText);
