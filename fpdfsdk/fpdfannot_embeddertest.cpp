...
TEST_F(FPDFAnnotEmbeddertest, AddAndModifyPath) {
  ...
  const char md5_3[] = "d6e50fdaa37f98632b4e6915ccfe582a";
  ...
  FPDF_PAGEOBJECT dot = FPDFPageObj_CreateNewPath(7.52, 84.35);
  EXPECT_TRUE(FPDFPath_BezierTo(dot, 9.31, 86.41, 10.54, 87.89, 11.22, 88.79));
  EXPECT_TRUE(FPDFPath_SetStrokeColor(dot, 255, 0, 0, 100));
  EXPECT_TRUE(FPDFPath_SetStrokeWidth(dot, 14.f));
