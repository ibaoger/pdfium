...
TEST_F(FPDFAnnotEmbeddertest, GetInteractiveFormAnnotationFlagsTextField) {
  ...
  int flags = FPDFAnnot_GetInteractiveFormFlags(page, annot);
  ...
  // Check that the flag values are as expected.
  flags = FPDFAnnot_GetInteractiveFormFlags(page, annot);
...
TEST_F(FPDFAnnotEmbeddertest, GetInteractiveFormAnnotationFlagsComboBox) {
  // Open file with form text fields.
...
TEST_F(FPDFAnnotEmbeddertest, GetFormAnnotNull) {
  ...
  FPDF_ANNOTATION annot =
      FPDFAnnot_GetInteractiveFormAnnotAtPoint(form_handle(), page, 0, 0);
  EXPECT_FALSE(annot);
...
TEST_F(FPDFAnnotEmbeddertest, GetFormAnnotAndCheckFlagsTextField) {
  ...
  FPDF_ANNOTATION annot =
      FPDFAnnot_GetInteractiveFormAnnotAtPoint(form_handle(), page, 105, 118);
  ASSERT_TRUE(annot);
  ...
  annot =
      FPDFAnnot_GetInteractiveFormAnnotAtPoint(form_handle(), page, 105, 202);
  ASSERT_TRUE(annot);
...
TEST_F(FPDFAnnotEmbeddertest, GetFormAnnotAndCheckFlagsComboBox) {
  ...
  FPDF_ANNOTATION annot =
      FPDFAnnot_GetInteractiveFormAnnotAtPoint(form_handle(), page, 102, 63);
  ASSERT_TRUE(annot);
  ...
  annot =
      FPDFAnnot_GetInteractiveFormAnnotAtPoint(form_handle(), page, 102, 113);
  ASSERT_TRUE(annot);
  ...
  annot =
      FPDFAnnot_GetInteractiveFormAnnotAtPoint(form_handle(), page, 102, 213);
  ASSERT_TRUE(annot);
