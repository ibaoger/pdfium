...
TEST_F(FPDFAnnotEmbeddertest, AddAndModifyPath) {
  ...
  std::cout << "Bitmap 1:\n";
  std::cout << FPDFBitmap_GetWidth(bitmap) << "\n";
  std::cout << FPDFBitmap_GetHeight(bitmap) << "\n";
  std::cout << HashBitmap(bitmap, FPDFBitmap_GetWidth(bitmap),   FPDFBitmap_GetHeight(bitmap)) << "\n";
  ...
  FILE* fp = fopen("jane_testing.pdf", "wb");
  ASSERT_TRUE(fp);
  ...
  bitmap = RenderPageWithFlags(new_page, FPDF_ANNOT);
  //CompareBitmap(bitmap, 595, 842, "c60c2cc2c4e7b13be90bd77cc4502f97");
  std::cout << "Bitmap 3:\n";
  std::cout << FPDFBitmap_GetWidth(bitmap) << "\n";
  std::cout << FPDFBitmap_GetHeight(bitmap) << "\n";
  std::cout << HashBitmap(bitmap, FPDFBitmap_GetWidth(bitmap),   FPDFBitmap_GetHeight(bitmap)) << "\n";
