...
// Ensure that sFormat contains at most one well-understood formatting
// directive which expects but a single argument, and return the type of
// argument expected, or -1 otherwise. If -1 is returned, it is NOT safe
