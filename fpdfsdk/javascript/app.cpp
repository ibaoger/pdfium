...
bool IsTypeUnknown(v8::Local<v8::Value> value) {
...
bool app::alert(CJS_Runtime* pRuntime,
  ...
  if (IsTypeUnknown(newParams[0].ToV8Value())) {
  ...
  int iIcon = 0;
  if (!IsTypeUnknown(newParams[1].ToV8Value()))
    iIcon = pRuntime->ToInt32(newParams[1].ToV8Value());

  int iType = 0;
  if (!IsTypeUnknown(newParams[2].ToV8Value()))
    iType = pRuntime->ToInt32(newParams[2].ToV8Value());

  WideString swTitle;
  if (!IsTypeUnknown(newParams[3].ToV8Value()))
...
bool app::mailMsg(CJS_Runtime* pRuntime,
  ...
  WideString cSubject;
  if (!IsTypeUnknown(newParams[4].ToV8Value()))
    cSubject = pRuntime->ToWideString(newParams[4].ToV8Value());

  WideString cMsg;
  if (!IsTypeUnknown(newParams[5].ToV8Value()))
