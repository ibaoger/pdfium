...
class CJS_Event : public CJS_Object {
 public:
  ...
  JS_STATIC_NAMED_PROP(changeEx, change_ex, event);
  JS_STATIC_NAMED_PROP(commitKey, commit_key, event);
  JS_STATIC_NAMED_PROP(fieldFull, field_full, event);
  JS_STATIC_NAMED_PROP(keyDown, key_down, event);
  JS_STATIC_PROP(modifier, event);
  JS_STATIC_PROP(name, event);
  JS_STATIC_PROP(rc, event);
  JS_STATIC_NAMED_PROP(richChange, rich_change, event);
  JS_STATIC_NAMED_PROP(richChangeEx, rich_change_ex, event);
  JS_STATIC_NAMED_PROP(richValue, rich_value, event);
  JS_STATIC_NAMED_PROP(selEnd, sel_end, event);
  JS_STATIC_NAMED_PROP(selStart, sel_start, event);
  JS_STATIC_PROP(shift, event);
  JS_STATIC_PROP(source, event);
  JS_STATIC_PROP(target, event);
  JS_STATIC_NAMED_PROP(targetName, target_name, event);
  JS_STATIC_PROP(type, event);
  JS_STATIC_PROP(value, event);
  JS_STATIC_NAMED_PROP(willCommit, will_commit, event);
};
