...
class CJS_Event : public CJS_Object {
 public:
  ...
  JS_STATIC_PROP(change_ex, event);
  JS_STATIC_PROP(commit_key, event);
  JS_STATIC_PROP(field_full, event);
  JS_STATIC_PROP(key_down, event);
  JS_STATIC_PROP(modifier, event);
  JS_STATIC_PROP(name, event);
  JS_STATIC_PROP(rc, event);
  JS_STATIC_PROP(rich_change, event);
  JS_STATIC_PROP(rich_change_ex, event);
  JS_STATIC_PROP(rich_value, event);
  JS_STATIC_PROP(sel_end, event);
  JS_STATIC_PROP(sel_start, event);
  JS_STATIC_PROP(shift, event);
  JS_STATIC_PROP(source, event);
  JS_STATIC_PROP(target, event);
  JS_STATIC_PROP(target_name, event);
  JS_STATIC_PROP(type, event);
  JS_STATIC_PROP(value, event);
  JS_STATIC_PROP(will_commit, event);
};
