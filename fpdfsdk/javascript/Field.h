...
class CJS_Field : public CJS_Object {
 public:
  ...
  JS_STATIC_PROP(border_style, Field);
  JS_STATIC_PROP(button_align_x, Field);
  JS_STATIC_PROP(button_align_y, Field);
  JS_STATIC_PROP(button_fit_bounds, Field);
  JS_STATIC_PROP(button_position, Field);
  JS_STATIC_PROP(button_scale_how, Field);
  JS_STATIC_PROP(button_scale_when, Field);
  JS_STATIC_PROP(calc_order_index, Field);
  JS_STATIC_PROP(char_limit, Field);
  JS_STATIC_PROP(comb, Field);
  JS_STATIC_PROP(commit_on_sel_change, Field);
  JS_STATIC_PROP(current_value_indices, Field);
  JS_STATIC_PROP(default_style, Field);
  JS_STATIC_PROP(default_value, Field);
  JS_STATIC_PROP(do_not_scroll, Field);
  JS_STATIC_PROP(do_not_spell_check, Field);
  JS_STATIC_PROP(delay, Field);
  JS_STATIC_PROP(display, Field);
  JS_STATIC_PROP(doc, Field);
  JS_STATIC_PROP(editable, Field);
  JS_STATIC_PROP(export_values, Field);
  JS_STATIC_PROP(file_select, Field);
  JS_STATIC_PROP(fill_color, Field);
  JS_STATIC_PROP(hidden, Field);
  JS_STATIC_PROP(highlight, Field);
  JS_STATIC_PROP(line_width, Field);
  JS_STATIC_PROP(multiline, Field);
  JS_STATIC_PROP(multiple_selection, Field);
  JS_STATIC_PROP(name, Field);
  JS_STATIC_PROP(num_items, Field);
  JS_STATIC_PROP(page, Field);
  JS_STATIC_PROP(password, Field);
  JS_STATIC_PROP(print, Field);
  JS_STATIC_PROP(radios_in_unison, Field);
  JS_STATIC_PROP(readonly, Field);
  JS_STATIC_PROP(rect, Field);
  JS_STATIC_PROP(required, Field);
  JS_STATIC_PROP(rich_text, Field);
  JS_STATIC_PROP(rich_value, Field);
  JS_STATIC_PROP(rotation, Field);
  JS_STATIC_PROP(stroke_color, Field);
  JS_STATIC_PROP(style, Field);
  JS_STATIC_PROP(submit_name, Field);
  JS_STATIC_PROP(text_color, Field);
  JS_STATIC_PROP(text_font, Field);
  JS_STATIC_PROP(text_size, Field);
  JS_STATIC_PROP(type, Field);
  JS_STATIC_PROP(user_name, Field);
  JS_STATIC_PROP(value, Field);
  JS_STATIC_PROP(value_as_string, Field);
