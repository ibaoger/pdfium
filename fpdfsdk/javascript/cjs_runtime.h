...
class CJS_Runtime : public IJS_Runtime,
 ...
 public:
  ...
  static CJS_Runtime* FromContext(const IJS_EventContext* cc);
  ...
  // IJS_Runtime
  IJS_EventContext* NewContext() override;
  void ReleaseContext(IJS_EventContext* pContext) override;
  IJS_EventContext* GetCurrentContext() override;
 ...
 private:
  ...
  std::vector<std::unique_ptr<CJS_EventContext>> m_ContextArray;
