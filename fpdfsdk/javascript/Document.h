...
class CJS_Document : public CJS_Object {
 public:
  ...
  JS_STATIC_PROP(base_URL, Document);
  JS_STATIC_PROP(bookmark_root, Document);
  JS_STATIC_PROP(calculate, Document);
  JS_STATIC_NAMED_PROP(Collab, collab, Document);
  JS_STATIC_NAMED_PROP(creationDate, creation_date, Document);
  JS_STATIC_PROP(creator, Document);
  JS_STATIC_PROP(delay, Document);
  JS_STATIC_PROP(dirty, Document);
  JS_STATIC_NAMED_PROP(documentFileName, document_file_name, Document);
  ...
  JS_STATIC_NAMED_PROP(modDate, mod_date, Document);
  JS_STATIC_NAMED_PROP(mouseX, mouse_x, Document);
  JS_STATIC_NAMED_PROP(mouseY, mouse_y, Document);
  JS_STATIC_NAMED_PROP(numFields, num_fields, Document);
  JS_STATIC_NAMED_PROP(numPages, num_pages, Document);
  JS_STATIC_NAMED_PROP(pageNum, page_num, Document);
  JS_STATIC_NAMED_PROP(pageWindowRect, page_window_rect, Document);
  ...
  JS_STATIC_NAMED_PROP(zoomType, zoom_type, Document);
