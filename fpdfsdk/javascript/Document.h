...
class CJS_Document : public CJS_Object {
 public:
  ...
  JS_STATIC_PROP(mod_date, Document);
  JS_STATIC_PROP(mouse_x, Document);
  JS_STATIC_PROP(mouse_y, Document);
  JS_STATIC_PROP(num_fields, Document);
  JS_STATIC_PROP(num_pages, Document);
  JS_STATIC_PROP(page_num, Document);
  JS_STATIC_PROP(page_window_rect, Document);
  ...
  JS_STATIC_PROP(zoom_type, Document);
