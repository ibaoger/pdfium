...
class CJS_App : public CJS_Object {
 public:
  ...
  JS_STATIC_NAMED_PROP(activeDocs, active_docs, app);
  JS_STATIC_PROP(calculate, app);
  JS_STATIC_NAMED_PROP(formsVersion, forms_version, app);
  ...
  JS_STATIC_NAMED_PROP(runtimeHighlight, runtime_highlight, app);
  JS_STATIC_NAMED_PROP(viewerType, viewer_type, app);
  JS_STATIC_NAMED_PROP(viewerVariation, viewer_variation, app);
  JS_STATIC_NAMED_PROP(viewerVersion, viewer_version, app);
