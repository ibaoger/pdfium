...
class CJS_App : public CJS_Object {
 public:
  ...
  JS_STATIC_PROP(active_docs, app);
  JS_STATIC_PROP(calculate, app);
  JS_STATIC_PROP(forms_version, app);
  ...
  JS_STATIC_PROP(runtime_highlight, app);
  JS_STATIC_PROP(viewer_type, app);
  JS_STATIC_PROP(viewer_variation, app);
  JS_STATIC_PROP(viewer_version, app);
