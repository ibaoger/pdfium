...
FPDF_EXPORT void CDECL FPDFPage_SetMediaBox(FPDF_PAGE page,
                                            float left,
                                            float bottom,
                                            float right,
                                            float top) {
...
FPDF_EXPORT void CDECL FPDFPage_SetCropBox(FPDF_PAGE page,
                                           float left,
                                           float bottom,
                                           float right,
                                           float top) {
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFPage_GetMediaBox(FPDF_PAGE page,
                                                 float* left,
                                                 float* bottom,
                                                 float* right,
                                                 float* top) {
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFPage_GetCropBox(FPDF_PAGE page,
                                                float* left,
                                                float* bottom,
                                                float* right,
                                                float* top) {
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFPage_TransFormWithClip(FPDF_PAGE page,
                                                       FS_MATRIX* matrix,
                                                       FS_RECTF* clipRect) {
  CPDF_Page* pPage = CPDFPageFromFPDFPage(page);
  if (!pPage)
...
FPDF_EXPORT FPDF_CLIPPATH CDECL FPDF_CreateClipPath(float left,
                                                    float bottom,
                                                    float right,
                                                    float top) {
  CPDF_Path Path;
...
FPDF_EXPORT void CDECL FPDF_DestroyClipPath(FPDF_CLIPPATH clipPath) {
...
FPDF_EXPORT void CDECL FPDFPage_InsertClipPath(FPDF_PAGE page,
