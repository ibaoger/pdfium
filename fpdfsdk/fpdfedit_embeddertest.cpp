...
TEST_F(FPDFEditEmbeddertest, AddPaths) {
  ...
  page_bitmap = RenderPage(page);
  const char lastMD5[] = "9823e1a21bd9b72b6a442ba4f12af946";
  CompareBitmap(page_bitmap, 612, 792, lastMD5);
  FPDFBitmap_Destroy(page_bitmap);
...
TEST_F(FPDFEditEmbeddertest, EditOverExistingContent) {
  ...
  const char lastMD5[] = "4b5b00f824620f8c9b8801ebb98e1cdd";
  CompareBitmap(new_bitmap, 612, 792, lastMD5);
  FPDFBitmap_Destroy(new_bitmap);
