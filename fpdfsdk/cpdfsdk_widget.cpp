...
void CPDFSDK_Widget::ResetAppearance(const CFX_WideString* sValue,
  ...
  CPWL_AppStream app_stream(this, this->GetAPDict());
  switch (GetFieldType()) {
    case FIELDTYPE_PUSHBUTTON:
      app_stream.SetAsPushButton();
      break;
    case FIELDTYPE_CHECKBOX:
      app_stream.SetAsCheckBox();
      break;
    case FIELDTYPE_RADIOBUTTON:
      app_stream.SetAsRadioButton();
      break;
    case FIELDTYPE_COMBOBOX:
      app_stream.SetAsComboBox(sValue);
      break;
    case FIELDTYPE_LISTBOX:
      app_stream.SetAsListBox();
      break;
    case FIELDTYPE_TEXTFIELD:
      app_stream.SetAsTextField(sValue);
      break;
  }
