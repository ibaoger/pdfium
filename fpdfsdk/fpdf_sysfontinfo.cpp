...
FPDF_EXPORT void CDECL FPDF_AddInstalledFont(void* mapper,
                                             const char* name,
                                             int charset) {
...
FPDF_EXPORT void CDECL FPDF_SetSystemFontInfo(FPDF_SYSFONTINFO* pFontInfoExt) {
...
FPDF_EXPORT const FPDF_CharsetFontMap* CDECL FPDF_GetDefaultTTFMap() {
...
FPDF_EXPORT FPDF_SYSFONTINFO* CDECL FPDF_GetDefaultSystemFontInfo() {
