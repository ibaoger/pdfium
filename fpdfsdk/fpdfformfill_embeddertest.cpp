...
TEST_F(FPDFFormFillEmbeddertest, FormText) {
  ...
  const char lastMD5[] = "65c64a7c355388f719a752aa1e23f6fe";
#else
...
#if _FXM_PLATFORM_ == _FXM_PLATFORM_APPLE_
    const char md5[] = "5f11dbe575fe197a37c3fb422559f8ff";
#else
    const char md5[] = "23baecc6e94d4c8b894cd39aa04c584c";
#endif
    CompareBitmap(bitmap1.get(), 300, 300, md5);
