...
static_assert(WindowsPrintMode::ModeEmf == FPDF_PRINTMODE_EMF,
              "WindowsPrintMode::ModeEmf value mismatch");
static_assert(WindowsPrintMode::ModeTextOnly == FPDF_PRINTMODE_TEXTONLY,
              "WindowsPrintMode::ModeTextOnly value mismatch");
static_assert(WindowsPrintMode::ModePostScript2 == FPDF_PRINTMODE_POSTSCRIPT2,
              "WindowsPrintMode::ModePostScript2 value mismatch");
static_assert(WindowsPrintMode::ModePostScript3 == FPDF_PRINTMODE_POSTSCRIPT3,
              "WindowsPrintMode::ModePostScript3 value mismatch");
#endif
