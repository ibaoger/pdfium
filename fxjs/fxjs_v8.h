...
class CFXJS_Engine {
 public:
  ...
  v8::Local<v8::Value> NewString(const CFX_ByteString& str);
  ...
  v8::Local<v8::String> BSToJSString(const CFX_ByteStringC& bsPropertyName);
  v8::Local<v8::String> WSToJSString(const CFX_WideStringC& wsPropertyName);
