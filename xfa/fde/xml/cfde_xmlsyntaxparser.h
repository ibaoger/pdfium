...
class CFDE_XMLSyntaxParser {
 public:
  ...
  FX_FILESIZE GetCurrentPos() const { return m_iParsedChars + m_pStart; }
 ...
 protected:
  ...
  FX_FILESIZE m_iParsedChars;
  std::vector<wchar_t> m_Buffer;
  int32_t m_iBufferChars;
  bool m_bEOS;
  FX_FILESIZE m_pStart;  // Start position in m_Buffer
  FX_FILESIZE m_pEnd;    // End position in m_Buffer
