...
static const FDE_CSSLengthUnitTable g_FDE_CSSLengthUnits[] = {
    {0x0672, FDE_CSSPrimitiveType::EMS}, {0x067D, FDE_CSSPrimitiveType::EXS},
    {0x1AF7, FDE_CSSPrimitiveType::IN},  {0x2F7A, FDE_CSSPrimitiveType::MM},
    {0x3ED3, FDE_CSSPrimitiveType::PC},  {0x3EE4, FDE_CSSPrimitiveType::PT},
    {0x3EE8, FDE_CSSPrimitiveType::PX},  {0xFC30, FDE_CSSPrimitiveType::CM},
};
...
FX_FLOAT CFDE_CSSPrimitiveValue::GetFloat() const {
  ASSERT(m_eType >= FDE_CSSPrimitiveType::Number &&
         m_eType <= FDE_CSSPrimitiveType::PC);
  return m_fNumber;
}
