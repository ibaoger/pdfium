...
FX_FLOAT CFDE_CSSStyleSelector::ApplyNumber(FDE_CSSPrimitiveType eUnit,
  ...
  switch (eUnit) {
    case FDE_CSSPrimitiveType::PX:
    case FDE_CSSPrimitiveType::Number:
      return fValue * 72 / 96;
    case FDE_CSSPrimitiveType::PT:
      return fValue;
    ...
    case FDE_CSSPrimitiveType::CM:
      return fValue * 28.3464f;
    case FDE_CSSPrimitiveType::MM:
      return fValue * 2.8346f;
    case FDE_CSSPrimitiveType::IN:
      return fValue * 72.0f;
    case FDE_CSSPrimitiveType::PC:
      return fValue / 12.0f;
    default:
      return fValue;
  }
