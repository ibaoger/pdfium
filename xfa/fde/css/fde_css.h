...
enum FDE_CSSVALUETYPE {
  ...
  FDE_CSSVALUETYPE_MaybeNumber = 1 << 3,
  FDE_CSSVALUETYPE_MaybeEnum = 1 << 4,
  FDE_CSSVALUETYPE_MaybeURI = 1 << 5,
  FDE_CSSVALUETYPE_MaybeString = 1 << 6,
  FDE_CSSVALUETYPE_MaybeColor = 1 << 7,
  FDE_CSSVALUETYPE_MaybeFunction = 1 << 8
};

enum class FDE_CSSPrimitiveType {
  Unknown = 0,
  Number,
  Percent,
  EMS,
...
enum class FDE_CSSPropertyValue {
  Bolder = 0,
  LowerLatin,
  Lowercase,
  LowerGreek,
...
enum class FDE_CSSPseudo { After, Before, NONE };

enum class FDE_CSSSelectorType {
  Element = 0,
  Descendant,
  Class,
  Pseudo,
...
enum class FDE_CSSRuleType { Style, Media, FontFace };

enum class FDE_CSSSyntaxStatus {
  Error,
  EOS,
  None,
  Charset,
...
enum class FDE_CSSBackgroundAttachment {
  Scroll,
  Fixed,
};

enum class FDE_CSSBackgroundRepeat {
  Repeat,
  RepeatX,
  RepeatY,
  NoRepeat,
...
enum class FDE_CSSVisibility {
  Visible,
  Hidden,
  Collapse,
};

enum class FDE_CSSFontStyle {
  Normal,
  Italic,
};

enum class FDE_CSSFloat {
  None,
  Left,
  Right,
};

enum class FDE_CSSWritingMode {
  HorizontalTb,
  VerticalRl,
  VerticalLr,
};

enum class FDE_CSSWordBreak {
  Normal,
  KeepAll,
  BreakAll,
  KeepWords,
...
enum class FDE_CSSTextEmphasisFill {
  Filled,
  Open,
};

enum class FDE_CSSTextEmphasisMark {
  None,
  Auto,
  Dot,
  Circle,
...
enum class FDE_CSSTextCombine {
  Horizontal,
  None,
};

enum class FDE_CSSCursor {
  Auto,
  Crosshair,
  Default,
  Pointer,
...
enum class FDE_CSSRubyOverhang {
  Auto,
  Start,
  End,
  None,
...
enum class FDE_CSSRubyPosition {
  Before,
  After,
  Right,
  Inline,
...
enum class FDE_CSSRubySpan {
  None,
  Attr,
};

enum class FDE_CSSTextAlign {
  Left,
  Right,
  Center,
  Justify,
...
enum class FDE_CSSVerticalAlign {
  Baseline,
  Sub,
  Super,
  Top,
...
enum class FDE_CSSListStyleType {
  Disc,
  Circle,
  Square,
  Decimal,
...
enum class FDE_CSSListStylePosition {
  Outside,
  Inside,
};

enum class FDE_CSSWhitespace {
  Normal,
  Pre,
  Nowrap,
  PreWrap,
...
enum class FDE_CSSFontVariant {
  Normal,
  SmallCaps,
};

enum class FDE_CSSTextTransform {
  None,
  Capitalize,
  UpperCase,
  LowerCase,
...
enum class FDE_CSSStyleSheetGroup {
  UserAgent = 0,
  User,
  Author,
};

enum class FDE_CSSStyleSheetPriority {
  High = 0,
  Mid,
  Low,
};
