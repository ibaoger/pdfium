...
struct FDE_TextStyle {
  ...
  uint8_t single_line_ : 1;
  uint8_t line_wrap_ : 1;
  uint8_t last_line_height_ : 1;
};
...
class CFDE_TextOut {
 public:
  ...
  int32_t GetTotalLines() { return m_iTotalLines; }
