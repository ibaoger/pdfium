...
const uint16_t gs_FX_WordBreak_Table[13] = {
    // WordBreakProperty::kNone
    kWordBreakValueNone | kWordBreakValueCR | kWordBreakValueLF |
        kWordBreakValueNewLine | kWordBreakValueExtend | kWordBreakValueFormat |
        kWordBreakValueKataKana | kWordBreakValueALetter |
        kWordBreakValueMidLetter | kWordBreakValueMidNum |
        kWordBreakValueMidNumLet | kWordBreakValueNumeric |
        kWordBreakValueExtendNumLet,

    // WordBreakProperty::kCR
    kWordBreakValueNone | kWordBreakValueNewLine | kWordBreakValueExtend |
        kWordBreakValueFormat | kWordBreakValueKataKana |
        kWordBreakValueALetter | kWordBreakValueMidLetter |
        kWordBreakValueMidNum | kWordBreakValueMidNumLet |
        kWordBreakValueNumeric | kWordBreakValueExtendNumLet,

    // WordBreakProperty::kLF
    kWordBreakValueNone | kWordBreakValueCR | kWordBreakValueNewLine |
        kWordBreakValueExtend | kWordBreakValueFormat |
        kWordBreakValueKataKana | kWordBreakValueALetter |
        kWordBreakValueMidLetter | kWordBreakValueMidNum |
        kWordBreakValueMidNumLet | kWordBreakValueNumeric |
        kWordBreakValueExtendNumLet,
    ...
    kWordBreakValueNone | kWordBreakValueCR | kWordBreakValueNewLine |
        kWordBreakValueExtend | kWordBreakValueFormat | kWordBreakValueALetter |
        kWordBreakValueMidLetter | kWordBreakValueMidNum |
        kWordBreakValueMidNumLet | kWordBreakValueNumeric,
    ...
    kWordBreakValueNone | kWordBreakValueCR | kWordBreakValueNewLine |
        kWordBreakValueExtend | kWordBreakValueFormat |
        kWordBreakValueKataKana | kWordBreakValueMidLetter |
        kWordBreakValueMidNum | kWordBreakValueMidNumLet,
