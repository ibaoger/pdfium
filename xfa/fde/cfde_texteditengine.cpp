 ...
 public:
  ...
  void Redo() const override {
    engine_->Insert(start_idx_, added_text_,
                    CFDE_TxtEdtEngine::RecordOperation::kSkip);
  }
...
void CFDE_TxtEdtEngine::Insert(size_t idx,
  ...
  if (add_operation == RecordOperation::kInsert) {
    AddOperationRecord(
...
void CFDE_TxtEdtEngine::ReplaceSelectedText(const CFX_WideString& rep) {
  ...
  CFX_WideString txt = DeleteSelectedText(RecordOperation::kSkip);
  Insert(gap_position_, rep, RecordOperation::kSkip);
