...
const CXFA_Node::PropertyData property_data[] = {{XFA_Element::Month, 12, 0},
                                                 {XFA_Element::Unknown, 0, 0}};
const XFA_Attribute attribute_data[] = {XFA_Attribute::Abbr,
                                        XFA_Attribute::Unknown};

const wchar_t* kName = L"monthNames";
