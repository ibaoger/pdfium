...
WideString CXFA_ValidateData::GetScriptMessageText() const {
  return GetMessageText(L"scriptTest");
}

void CXFA_ValidateData::SetScriptMessageText(const WideString& wsMessage) {
  SetMessageText(L"scriptTest", wsMessage);
}
