...
const CXFA_Node::PropertyData property_data[] = {
    {XFA_Element::Execute, 1, 0},  {XFA_Element::Script, 1, 0},
    {XFA_Element::SignData, 1, 0}, {XFA_Element::Extras, 1, 0},
    {XFA_Element::Submit, 1, 0},   {XFA_Element::Unknown, 0, 0}};
