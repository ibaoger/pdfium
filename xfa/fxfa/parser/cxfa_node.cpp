...
void CXFA_Node::Script_TreeClass_Nodes(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    FXJSE_ThrowMessage(FX_UTF8Encode(wsMessage.AsStringC()).AsStringC());
  } else {
...
void CXFA_Node::Script_TreeClass_SomExpression(CFXJSE_Value* pValue,
  ...
  pValue->SetString(FX_UTF8Encode(wsSOMExpression.AsStringC()).AsStringC());
}
...
void CXFA_Node::Script_NodeClass_GetAttribute(CFXJSE_Arguments* pArguments) {
  ...
  CFXJSE_Value* pValue = pArguments->GetReturnValue();
  if (pValue)
    pValue->SetString(FX_UTF8Encode(wsValue.AsStringC()).AsStringC());
}
...
void CXFA_Node::Script_NodeClass_Ns(CFXJSE_Value* pValue,
  ...
  pValue->SetString(FX_UTF8Encode(wsNameSpace.AsStringC()).AsStringC());
}
...
void CXFA_Node::Script_Som_Message(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    pValue->SetString(FX_UTF8Encode(wsMessage.AsStringC()).AsStringC());
  }
}
...
void CXFA_Node::Script_Som_DefaultValue(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    if (content.IsEmpty() && eType != XFA_Element::Text &&
      ...
      pValue->SetString(FX_UTF8Encode(content.AsStringC()).AsStringC());
    }
  }
}
...
void CXFA_Node::Script_Som_BorderColor(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    pValue->SetString(FX_UTF8Encode(strColor.AsStringC()).AsStringC());
  }
}
...
void CXFA_Node::Script_Som_BorderWidth(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    pValue->SetString(FX_UTF8Encode(wsThickness.AsStringC()).AsStringC());
  }
}
...
void CXFA_Node::Script_Som_FillColor(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    pValue->SetString(FX_UTF8Encode(wsColor.AsStringC()).AsStringC());
  }
}
...
void CXFA_Node::Script_Field_GetSaveItem(CFXJSE_Arguments* pArguments) {
  ...
  if (bHasItem) {
    pArguments->GetReturnValue()->SetString(
        FX_UTF8Encode(wsValue.AsStringC()).AsStringC());
  } else {
    pArguments->GetReturnValue()->SetNull();
  }
}
...
void CXFA_Node::Script_Field_BoundItem(CFXJSE_Arguments* pArguments) {
  ...
  CFXJSE_Value* pValue = pArguments->GetReturnValue();
  if (pValue)
    pValue->SetString(FX_UTF8Encode(wsBoundValue.AsStringC()).AsStringC());
}
...
void CXFA_Node::Script_Subform_Locale(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    pValue->SetString(FX_UTF8Encode(wsLocaleName.AsStringC()).AsStringC());
  }
}
...
void CXFA_Node::Script_Form_Checksum(CFXJSE_Value* pValue,
  ...
  pValue->SetString(FX_UTF8Encode(wsChecksum.AsStringC()).AsStringC());
}
...
void CXFA_Node::Script_Packet_GetAttribute(CFXJSE_Arguments* pArguments) {
  ...
  pArguments->GetReturnValue()->SetString(
      FX_UTF8Encode(wsAttributeValue.AsStringC()).AsStringC());
}
...
void CXFA_Node::Script_Packet_Content(CFXJSE_Value* pValue,
  ...
  if (bSetting) {
    ...
    pValue->SetString(FX_UTF8Encode(wsTextData.AsStringC()).AsStringC());
  }
}
