...
// There are uint8_t items, but because of the -1 we have to bump this
// up to an int16_t to hold them all. (Note, these values are static_cast
/// to uint8_t values.)
