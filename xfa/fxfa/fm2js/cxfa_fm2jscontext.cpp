...
void CXFA_FM2JSContext::Decode(CFXJSE_Value* pThis,
  ...
  if (argc == 1) {
    ...
    CFX_WideString decoded = DecodeURL(toDecodeWideString);
    CFX_ByteString decodedByteString = FX_UTF8Encode(decoded.AsStringC());
    args.GetReturnValue()->SetString(decodedByteString.AsStringC());
    return;
  }
...
void CXFA_FM2JSContext::Encode(CFXJSE_Value* pThis,
  ...
  if (argc == 1) {
    ...
    CFX_WideString encoded = EncodeURL(toEncodeString.AsStringC());
    CFX_ByteString encodedByteString = FX_UTF8Encode(encoded.AsStringC());
    args.GetReturnValue()->SetString(encodedByteString.AsStringC());
    return;
  }
...
// static
CFX_WideString CXFA_FM2JSContext::EncodeURL(
...
// static
CFX_WideString CXFA_FM2JSContext::EncodeXML(
