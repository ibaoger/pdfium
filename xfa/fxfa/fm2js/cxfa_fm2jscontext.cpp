...
const XFA_FMHtmlReserveCode reservesForDecode[] = {
    {193, L"Aacute"},   {225, L"aacute"},  {194, L"Acirc"},
    {226, L"acirc"},    {180, L"acute"},   {198, L"AElig"},
    {230, L"aelig"},    {192, L"Agrave"},  {224, L"agrave"},
    {8501, L"alefsym"}, {913, L"Alpha"},   {945, L"alpha"},
    {38, L"amp"},       {8743, L"and"},    {8736, L"ang"},
    {39, L"apos"},      {197, L"Aring"},   {229, L"aring"},
    {8776, L"asymp"},   {195, L"Atilde"},  {227, L"atilde"},
    {196, L"Auml"},     {228, L"auml"},    {8222, L"bdquo"},
    {914, L"Beta"},     {946, L"beta"},    {166, L"brvbar"},
    {8226, L"bull"},    {8745, L"cap"},    {199, L"Ccedil"},
    {231, L"ccedil"},   {184, L"cedil"},   {162, L"cent"},
    {935, L"Chi"},      {967, L"chi"},     {710, L"circ"},
    {9827, L"clubs"},   {8773, L"cong"},   {169, L"copy"},
    {8629, L"crarr"},   {8746, L"cup"},    {164, L"current"},
    {8224, L"dagger"},  {8225, L"Dagger"}, {8595, L"darr"},
    {8659, L"dArr"},    {176, L"deg"},     {916, L"Delta"},
    {948, L"delta"},    {9830, L"diams"},  {247, L"divide"},
    {201, L"Eacute"},   {233, L"eacute"},  {202, L"Ecirc"},
    {234, L"ecirc"},    {200, L"Egrave"},  {232, L"egrave"},
    {8709, L"empty"},   {8195, L"emsp"},   {8194, L"ensp"},
    {917, L"Epsilon"},  {949, L"epsilon"}, {8801, L"equiv"},
    {919, L"Eta"},      {951, L"eta"},     {208, L"ETH"},
    {240, L"eth"},      {203, L"Euml"},    {235, L"euml"},
    {8364, L"euro"},    {8707, L"exist"},  {402, L"fnof"},
    {8704, L"forall"},  {189, L"frac12"},  {188, L"frac14"},
    {190, L"frac34"},   {8260, L"frasl"},  {915, L"Gamma"},
    {947, L"gamma"},    {8805, L"ge"},     {62, L"gt"},
    {8596, L"harr"},    {8660, L"hArr"},   {9829, L"hearts"},
    {8230, L"hellip"},  {237, L"iacute"},  {238, L"icirc"},
    {161, L"iexcl"},    {236, L"igrave"},  {8465, L"image"},
    {8734, L"infin"},   {8747, L"int"},    {953, L"iota"},
    {191, L"iquest"},   {8712, L"isin"},   {239, L"iuml"},
    {922, L"Kappa"},    {954, L"kappa"},   {205, L"lacute"},
    {923, L"Lambda"},   {955, L"lambda"},  {9001, L"lang"},
    {171, L"laquo"},    {8592, L"larr"},   {8656, L"lArr"},
    ...
    {8722, L"minus"},   {924, L"Mu"},      {956, L"mu"},
    {8711, L"nabla"},   {160, L"nbsp"},    {8211, L"ndash"},
    {8800, L"ne"},      {8715, L"ni"},     {172, L"not"},
    {8713, L"notin"},   {8836, L"nsub"},   {209, L"Ntilde"},
    {241, L"ntilde"},   {925, L"Nu"},      {957, L"nu"},
    {211, L"Oacute"},   {243, L"oacute"},  {212, L"Ocirc"},
    {244, L"ocirc"},    {338, L"OElig"},   {339, L"oelig"},
    {210, L"Ograve"},   {242, L"ograve"},  {8254, L"oline"},
    {937, L"Omega"},    {969, L"omega"},   {927, L"Omicron"},
    {959, L"omicron"},  {8853, L"oplus"},  {8744, L"or"},
    {170, L"ordf"},     {186, L"ordm"},    {216, L"Oslash"},
    {248, L"oslash"},   {213, L"Otilde"},  {245, L"otilde"},
    {8855, L"otimes"},  {214, L"Ouml"},    {246, L"ouml"},
    {182, L"para"},     {8706, L"part"},   {8240, L"permil"},
    {8869, L"perp"},    {934, L"Phi"},     {966, L"phi"},
    {928, L"Pi"},       {960, L"pi"},      {982, L"piv"},
    {177, L"plusmn"},   {8242, L"prime"},  {8719, L"prod"},
    {8733, L"prop"},    {936, L"Psi"},     {968, L"psi"},
    {163, L"pund"},     {34, L"quot"},     {8730, L"radic"},
    {9002, L"rang"},    {187, L"raquo"},   {8594, L"rarr"},
    {8658, L"rArr"},    {8969, L"rceil"},  {8476, L"real"},
    {174, L"reg"},      {8971, L"rfloor"}, {929, L"Rho"},
    {961, L"rho"},      {8207, L"rlm"},    {8250, L"rsaquo"},
    {8217, L"rsquo"},   {353, L"saron"},   {8218, L"sbquo"},
    {352, L"Scaron"},   {8901, L"sdot"},   {167, L"sect"},
    {173, L"shy"},      {931, L"Sigma"},   {963, L"sigma"},
    ...
    {932, L"Tau"},      {964, L"tau"},     {8221, L"tdquo"},
    {8756, L"there4"},  {920, L"Theta"},   {952, L"theta"},
    {977, L"thetasym"}, {8201, L"thinsp"}, {222, L"THORN"},
    {254, L"thorn"},    {732, L"tilde"},   {215, L"times"},
    {8482, L"trade"},   {218, L"Uacute"},  {250, L"uacute"},
    {8593, L"uarr"},    {8657, L"uArr"},   {219, L"Ucirc"},
    {251, L"ucirc"},    {217, L"Ugrave"},  {249, L"ugrave"},
    {168, L"uml"},      {978, L"upsih"},   {933, L"Upsilon"},
    {965, L"upsilon"},  {220, L"Uuml"},    {252, L"uuml"},
    {8472, L"weierp"},  {926, L"Xi"},      {958, L"xi"},
    {221, L"Yacute"},   {253, L"yacute"},  {165, L"yen"},
    {255, L"yuml"},     {376, L"Yuml"},    {918, L"Zeta"},
...
bool CXFA_FM2JSContext::HTMLSTR2Code(const CFX_WideStringC& pData,
  ...
  const XFA_FMHtmlReserveCode* result = std::lower_bound(
      std::begin(reservesForDecode), std::end(reservesForDecode), pData,
      [](const XFA_FMHtmlReserveCode iter, const CFX_WideStringC& val) {
        return val > iter.m_htmlReserve;
      });
  if (result != std::end(reservesForEncode) && pData == result->m_htmlReserve) {
