...
class CXFA_FM2JSContext : public CFXJSE_HostObject {
 public:
  ...
  static void Decode(CFXJSE_Value* pThis,
                     const CFX_ByteStringC& szFuncName,
                     CFXJSE_Arguments& args);
  static CFX_ByteString DecodeURL(const CFX_WideString& wsURLString);
  static CFX_ByteString DecodeHTML(const CFX_WideString& wsHTMLString);
  static CFX_ByteString DecodeXML(const CFX_WideString& wsXMLString);
