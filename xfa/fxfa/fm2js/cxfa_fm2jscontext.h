...
class CXFA_FM2JSContext : public CFXJSE_HostObject {
 public:
  ...
  static void Encode(CFXJSE_Value* pThis,
                     const CFX_ByteStringC& szFuncName,
                     CFXJSE_Arguments& args);
  static CFX_WideString EncodeURL(const CFX_ByteStringC& szURLString);
  static CFX_WideString EncodeHTML(const CFX_ByteStringC& szHTMLString);
  static CFX_WideString EncodeXML(const CFX_ByteStringC& szXMLString);
