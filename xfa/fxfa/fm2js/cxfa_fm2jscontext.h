...
class CXFA_FM2JSContext : public CFXJSE_HostObject {
 public:
  ...
  static void Decode(CFXJSE_Value* pThis,
                     const CFX_ByteStringC& szFuncName,
                     CFXJSE_Arguments& args);
  static CFX_ByteString DecodeURL(const CFX_ByteStringC& szURLString);
  static CFX_ByteString DecodeHTML(const CFX_ByteStringC& szHTMLString);
  static CFX_ByteString DecodeXML(const CFX_ByteStringC& szXMLString);
  static void Encode(CFXJSE_Value* pThis,
                     const CFX_ByteStringC& szFuncName,
                     CFXJSE_Arguments& args);
  static CFX_ByteString EncodeURL(const CFX_ByteStringC& szURLString);
  static CFX_ByteString EncodeHTML(const CFX_ByteStringC& szHTMLString);
  static CFX_ByteString EncodeXML(const CFX_ByteStringC& szXMLString);
  ...
  static CFX_ByteString WordUS(const CFX_ByteStringC& szData, int32_t iStyle);
