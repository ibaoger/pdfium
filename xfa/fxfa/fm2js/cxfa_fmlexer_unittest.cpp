...
TEST(CXFA_FMLexerTest, InvalidIdentifiers) {
  ...
  lexer->NextToken();
  // TODO(pdfium:814): Add an expects for the return being nullptr here.
  ...
  // TODO(pdfium:814): Add an expects for the return being nullptr here.
  EXPECT_TRUE(lexer->HasError());
  // TODO(pdfium:814): Add a test for if an another call to NextToken occurs,
  //                   the error state will be retained, instead of continuing
  //                   the parse.
