...
DLLEXPORT int STDCALL FPDFAnnot_GetSubtype(FPDF_ANNOTATION annot);
...
// Get the attachment points (i.e. quadpoints) of an annotation. Quadpoints are
// the vertices of the rectange that encompasses the texts affected by the
// annotation. They provide the coordinates in the page where the annotation is
// attached. Applicable to markup annotations only (i.e. highlight, strikeout,
