...
// text objects are supported for modification currently; see FPDFPath_*(),
// FPDFText_*(), and FPDFImageObj_*().
//
//   annot  - handle to an annotation.
...
// Also note that only path, image, and text objects are supported for creation.
//
//   annot  - handle to an annotation.
...
// Get the number of objects in |annot|, including path objects, text objects,
// external objects, image objects, and shading objects.
//
//   annot  - handle to an annotation.
//
