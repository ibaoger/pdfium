...
//   page   - handle to a page.
//
// Returns the count of annotations in |page|, or -1 if |page| is null or empty.
...
// will be appended to |annot|'s current list of paths.
//
//   annot  - handle to an annotation.
...
//   annot  - handle to an annotation.
//
// Returns the number of path objects in |annot|, or -1 if |annot| is null.
