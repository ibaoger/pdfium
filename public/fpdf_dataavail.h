...
FPDF_EXPORT FPDF_AVAIL CDECL FPDFAvail_Create(FX_FILEAVAIL* file_avail,
                                              FPDF_FILEACCESS* file);

// Destroy the |avail| document availability provider.
//
//   avail - handle to document availability provider to be destroyed.
FPDF_EXPORT void CDECL FPDFAvail_Destroy(FPDF_AVAIL avail);
...
FPDF_EXPORT FPDF_DOCUMENT CDECL FPDFAvail_GetDocument(FPDF_AVAIL avail,
...
FPDF_EXPORT int CDECL FPDFAvail_GetFirstPageNum(FPDF_DOCUMENT doc);
...
// loading.
FPDF_EXPORT int CDECL FPDFAvail_IsPageAvail(FPDF_AVAIL avail,
                                            int page_index,
...
FPDF_EXPORT int CDECL FPDFAvail_IsFormAvail(FPDF_AVAIL avail,
                                            FX_DOWNLOADHINTS* hints);
...
FPDF_EXPORT int CDECL FPDFAvail_IsLinearized(FPDF_AVAIL avail);
