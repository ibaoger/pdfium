...
FPDF_EXPORT unsigned long CDECL FPDFBookmark_GetTitle(FPDF_BOOKMARK bookmark,
                                                      void* buffer,
...
FPDF_EXPORT FPDF_ACTION CDECL FPDFBookmark_GetAction(FPDF_BOOKMARK bookmark);
...
//   PDFACTION_URI
//   PDFACTION_LAUNCH
FPDF_EXPORT unsigned long CDECL FPDFAction_GetType(FPDF_ACTION action);
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFDest_GetLocationInPage(FPDF_DEST dest,
                                                       FPDF_BOOL* hasXCoord,
                                                       FPDF_BOOL* hasYCoord,
                                                       FPDF_BOOL* hasZoom,
                                                       FS_FLOAT* x,
...
FPDF_EXPORT FPDF_ACTION CDECL FPDFLink_GetAction(FPDF_LINK link);
