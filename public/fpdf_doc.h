...
#define PDFDEST_VIEW_XYZ 0
#define PDFDEST_VIEW_FIT 1
#define PDFDEST_VIEW_FITH 2
#define PDFDEST_VIEW_FITV 3
#define PDFDEST_VIEW_FITR 4
#define PDFDEST_VIEW_FITB 5
#define PDFDEST_VIEW_FITBH 6
#define PDFDEST_VIEW_FITBV 7
