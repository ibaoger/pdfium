...
FPDF_EXPORT FPDF_DOCUMENT CDECL FPDF_CreateNewDocument();
...
FPDF_EXPORT FPDF_PAGE CDECL FPDFPage_New(FPDF_DOCUMENT document,
                                         int page_index,
                                         double width,
                                         double height);
...
FPDF_EXPORT void CDECL FPDFPage_Delete(FPDF_DOCUMENT document, int page_index);
...
FPDF_EXPORT int CDECL FPDFPage_GetRotation(FPDF_PAGE page);
...
//              2 - Rotated 180 degrees clockwise.
//              3 - Rotated 270 degrees clockwise.
FPDF_EXPORT void CDECL FPDFPage_SetRotation(FPDF_PAGE page, int rotate);
...
//              freed.
FPDF_EXPORT void CDECL FPDFPage_InsertObject(FPDF_PAGE page,
...
FPDF_EXPORT int CDECL FPDFPage_CountObject(FPDF_PAGE page);
...
FPDF_EXPORT FPDF_PAGEOBJECT CDECL FPDFPage_GetObject(FPDF_PAGE page, int index);
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFPage_HasTransparency(FPDF_PAGE page);
...
FPDF_EXPORT FPDF_BOOL CDECL FPDFPage_GenerateContent(FPDF_PAGE page);
...
// error.
FPDF_EXPORT int CDECL FPDFPageObj_GetType(FPDF_PAGEOBJECT page_object);
...
FPDF_EXPORT void CDECL FPDFPageObj_Transform(FPDF_PAGEOBJECT page_object,
                                             double a,
                                             double b,
                                             double c,
                                             double d,
...
FPDF_EXPORT void CDECL FPDFPage_TransformAnnots(FPDF_PAGE page,
                                                double a,
                                                double b,
                                                double c,
                                                double d,
...
FPDF_EXPORT FPDF_PAGEOBJECT CDECL
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFImageObj_SetMatrix(FPDF_PAGEOBJECT image_object,
                                                   double a,
                                                   double b,
                                                   double c,
                                                   double d,
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFImageObj_SetBitmap(FPDF_PAGE* pages,
                                                   int nCount,
                                                   FPDF_PAGEOBJECT image_object,
                                                   FPDF_BITMAP bitmap);
...
FPDF_EXPORT FPDF_PAGEOBJECT CDECL FPDFPageObj_CreateNewPath(float x, float y);
...
FPDF_EXPORT FPDF_PAGEOBJECT CDECL FPDFPageObj_CreateNewRect(float x,
                                                            float y,
                                                            float w,
                                                            float h);
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFPageObj_GetBounds(FPDF_PAGEOBJECT page_object,
                                                  float* left,
                                                  float* bottom,
                                                  float* right,
                                                  float* top);
...
FPDF_EXPORT void CDECL FPDFPageObj_SetBlendMode(FPDF_PAGEOBJECT page_object,
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_SetStrokeColor(FPDF_PAGEOBJECT path,
                                                    unsigned int R,
                                                    unsigned int G,
                                                    unsigned int B,
                                                    unsigned int A);
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_GetStrokeColor(FPDF_PAGEOBJECT path,
                                                    unsigned int* R,
                                                    unsigned int* G,
                                                    unsigned int* B,
                                                    unsigned int* A);
...
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_SetStrokeWidth(FPDF_PAGEOBJECT path,
                                                    float width);
...
// FPDF_LINEJOIN_BEVEL
FPDF_EXPORT void CDECL CDECL FPDFPath_SetLineJoin(FPDF_PAGEOBJECT page_object,
                                                    int line_join);
...
FPDF_EXPORT void CDECL FPDFPath_SetLineCap(FPDF_PAGEOBJECT page_object,
                                           int line_cap);
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_SetFillColor(FPDF_PAGEOBJECT path,
                                                  unsigned int R,
                                                  unsigned int G,
                                                  unsigned int B,
                                                  unsigned int A);
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_GetFillColor(FPDF_PAGEOBJECT path,
                                                  unsigned int* R,
                                                  unsigned int* G,
                                                  unsigned int* B,
                                                  unsigned int* A);
...
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_MoveTo(FPDF_PAGEOBJECT path,
                                            float x,
                                            float y);
...
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_LineTo(FPDF_PAGEOBJECT path,
                                            float x,
                                            float y);
...
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_BezierTo(FPDF_PAGEOBJECT path,
                                              float x1,
                                              float y1,
                                              float x2,
                                              float y2,
...
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_Close(FPDF_PAGEOBJECT path);
...
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL CDECL FPDFPath_SetDrawMode(FPDF_PAGEOBJECT path,
                                                 int fillmode,
                                                 FPDF_BOOL stroke);
...
FPDF_EXPORT FPDF_PAGEOBJECT CDECL FPDFPageObj_NewTextObj(FPDF_DOCUMENT document,
...
//
// Returns TRUE on success
FPDF_EXPORT FPDF_BOOL CDECL FPDFText_SetText(FPDF_PAGEOBJECT text_object,
...
FPDF_EXPORT FPDF_FONT CDECL FPDFText_LoadFont(FPDF_DOCUMENT document,
                                              const uint8_t* data,
                                              uint32_t size,
                                              int font_type,
                                              FPDF_BOOL cid);
...
//
// Returns TRUE on success.
FPDF_EXPORT FPDF_BOOL CDECL FPDFText_SetFillColor(FPDF_PAGEOBJECT text_object,
                                                  unsigned int R,
                                                  unsigned int G,
                                                  unsigned int B,
                                                  unsigned int A);
...
FPDF_EXPORT void CDECL FPDFFont_Close(FPDF_FONT font);
