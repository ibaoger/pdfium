...
// R      - the R component for the path stroke color.
// G      - the G component for the path stroke color.
// B      - the B component for the path stroke color.
...
//
// path   - the handle to the path object.
// R      - the R component for the path fill color.
// G      - the G component for the path fill color.
// B      - the B component for the path fill color.
