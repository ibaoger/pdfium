...
typedef struct _FPDF_IMAGEOBJ_METADATA_ {
...
// pixel, and colorspace. Failure to retrieve any parameter would result in its
// value being 0.
//
//   image_object - handle to an image object.
//   page         - handle to the page that |image_object| is on. Needed for
//                  retrieving the image's bits per pixel and colorspace.
//
// Returns the image metadata.
DLLEXPORT FPDF_IMAGEOBJ_METADATA STDCALL
FPDFImageObj_GetImageMetadata(FPDF_PAGEOBJECT image_object, FPDF_PAGE page);
