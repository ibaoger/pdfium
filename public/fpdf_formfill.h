...
#define FORMTYPE_OTHER 0      // Document contains an unknown form type
#define FORMTYPE_NONE 1       // Document contains no forms
#define FORMTYPE_ACRO_FORM 2  // Forms are specified using AcroForm spec
#define FORMTYPE_XFA_FULL 3   // Forms are specified using the entire XFA spec
#define FORMTYPE_XFA_FOREGROUND \
  4  // Forms are specified using the XFAF subset of XFA spec
#define FORMTYPE_COUNT 5  // The number of form types
