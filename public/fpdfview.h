...
//                 FPDF_PRINTMODE_TEXTONLY to print text only (for charstream
//                 devices)
//                 FPDF_PRINTMODE_POSTSCRIPT2 to print level 2 postscript
//                 FPDF_PRINTMODE_POSTSCRIPT3 to print level 3 postscript
// Return value:
