...
#else
#define FPDF_EXPORT
#endif // defined(PDF_COMPONENT_BUILD)

#if defined(WIN32) && !defined(FPDF_CALLCONV)
...
FPDF_EXPORT FPDF_BOOL FPDF_CALLCONV FPDF_SetPrintPostscriptLevel(int postscript_level);
