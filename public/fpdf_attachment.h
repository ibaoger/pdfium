...
// The creation date and checksum will also be updated, while all other
// dictionary entries will be deleted.
//
//   attachment - handle to an attachment.
//   contents   - buffer holding the file's data to be written in raw bytes.
